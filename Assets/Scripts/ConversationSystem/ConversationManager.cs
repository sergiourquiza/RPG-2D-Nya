...
public class ConversationManager : MonoBehaviour
{
    ...
    public void StartConverstaion(Conversation conversation){
        mActiveConversation = conversation;
        OnConversationStart?.Invoke(mActiveConversation.Interactions[mInteractionIndex++]);
    }
    public void NextConverstaion(){
        if(mInteractionIndex < mActiveConversation.Interactions.Count){
            OnConversationNext?.Invoke(mActiveConversation.Interactions[mInteractionIndex++]);
        }
        else{
